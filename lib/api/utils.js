...
//   - 2+ photos
//   - non-empty bio
//   - city, gymName, goal, timing, level
export function computeProfileCompletion(p) {
  ...
  const checks = [
    ...
    { key: 'bio', ok: !!(p.bio && String(p.bio).trim().length >= 10), label: 'Write a short bio (10+ chars)' },
    { key: 'city', ok: !!p.city, label: 'Pick your city' },
    { key: 'gymName', ok: !!p.gymName, label: 'Add your gym' },
    { key: 'goal', ok: !!p.goal, label: 'Pick your workout goal' },
