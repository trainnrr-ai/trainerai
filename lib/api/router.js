...
import { postAuthSession, postAuthFirebase, getAuthMe, postAuthLogout } from './handlers/auth'
...
export async function dispatch(request, { params }) {
  ...
  try {
    ...
    // Auth endpoints skip this so login cannot fail because of unrelated cleanup.
