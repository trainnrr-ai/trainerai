...
export const BANNED_WORDS = [
  ...
  'fuck', 'fucking', 'bitch', 'bastard', 'slut', 'whore', 'motherfucker', 'mf', 'asshole', 'idiot',
  // Hindi Profanity
  'chutiya', 'madarchod', 'mc', 'behenchod', 'bc', 'bhosdike', 'lund', 'randi', 'gaand',
  // Adult & Dating Terms
  'nude', 'nudes', 'hookup', 'sex', 'sexual', 'sext', 'sexting', 'kiss', 'kissing', 'makeout',
  'one night stand', 'friends with benefits', 'fwb', 'horny', 'hot pics', 'send pics', 'send photo',
  'send nudes', 'sugar daddy', 'sugar mommy', 'call girl', 'prostitute', 'porn', 'xxx',
  // Previous words
  'sexy', 'dick', 'pussy', 'boobs'
]
