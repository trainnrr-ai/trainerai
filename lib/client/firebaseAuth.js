...
function getFirebaseConfig() {
  ...
  const defaultAuthDomain = process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'trainr-1f76a.firebaseapp.com'
  const cfg = {
    apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY,
    authDomain: typeof window !== 'undefined' && !isDev ? window.location.host : defaultAuthDomain,
